package com.adityaaryobima.resepdunia;
...
// Pastikan import ini ada biar gak error merah di ActivityMainBinding
import com.adityaaryobima.resepdunia.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Resep Dunia");
        }
    ...
    public void loadDataFromApi() {
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest(
                ...
                error -> {
                    binding.progressBar.setVisibility(View.GONE);
                    Toast.makeText(this, "Gagal memuat data. Periksa koneksi internet!", Toast.LENGTH_SHORT).show();
                }
        );
